...
use crate::pst::mapi::{
    ...
    PR_REPLY_REQUESTED, PR_SENDER_ADDRTYPE, PR_SENDER_ADDRTYPE_A, PR_SENDER_EMAIL_ADDRESS,
    PR_SENDER_EMAIL_ADDRESS_A, PR_SENDER_NAME, PR_SENDER_NAME_A, PR_SENSITIVITY,
    PR_SENT_REPRESENTING_ADDRTYPE, PR_SENT_REPRESENTING_ADDRTYPE_A,
    PR_SENT_REPRESENTING_EMAIL_ADDRESS, PR_SENT_REPRESENTING_EMAIL_ADDRESS_A, PR_SUBJECT,
