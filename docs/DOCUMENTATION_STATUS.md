...
| `docs/readpst-gaps/README.md` | Authoritative readpst capability comparison, implementation blueprint, issue slicing, parity matrix, closure plan, and multi-agent execution entry point. |
...
- the matrix currently records 10 Implemented, 53 Partial, and 14 Gap rows after the post-RP-M7 output expansion, easiest-closure wave, and attachment metadata closure; fixture breadth, mixed item/output semantics, and broad address/body fidelity remain incomplete;
