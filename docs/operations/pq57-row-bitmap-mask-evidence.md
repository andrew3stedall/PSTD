...
## Validated public-fixture result

GitHub Actions run 453 passed the complete Rust, Python, Docker, CLI, and public-PST workflow. The artifact exposed four identical masks:

`11111011000000:11111011000000:11111011000000:11111011000000`

All four masks are 14 characters long and retain the PQ56 counts of seven set and seven unset bits. The fixture also retains 11 folders, one discovered and extracted message, two body payloads, 16 selected properties, 19 unknown properties, and no attachments. This is structural evidence only; it does not establish property presence or decode any row value.
