...
ANSI message/output shape only; ANSI method-1/method-2 attachment layouts are covered by
separate Stage-C fixtures, while methods 3/4, HTML/RTF bodies, typed items, producer
