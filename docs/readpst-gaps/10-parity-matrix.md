...
| ATT-04 | By-reference methods 2/3/4 | Partial | #581, #582, and #583 prove deterministic ANSI method-2, method-3, and method-4 property-context HNID/SLBLOCK mappings with exact method metadata, canonical payload hashes, inline MIME/base64, external file/manifests, repeatability, and fail-closed truncation evidence; external ID2/path layouts and broad reference producer corpus remain. |
