...
| Bodies/attachments | Payload wiring and CI validated | M10 adds node payload-to-property wiring and attachment table-to-payload wiring. |
...
The M1-M10 foundation has CI coverage at the unit, smoke, Docker, and fixture level. M10 adds payload wiring helpers, but parser-depth risk remains: real-world payload extraction still depends on deeper subnode decoding and main extraction-path integration.
