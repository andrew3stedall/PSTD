...
M6: Batch Orchestration and Resume.
...
The M1-M5 foundation has CI coverage at the unit, smoke, Docker, and fixture level. M5 adds deterministic body and attachment output helpers, but real-world payload extraction still depends on deeper BBT/NBT, property-context, and attachment subnode traversal coverage.
